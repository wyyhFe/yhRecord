  ...
  <view class="glass-panel px-[24rpx] py-[24rpx]">
    ...
    <view class="mt-[20rpx] grid grid-cols-3 gap-[16rpx]">
      ...
      >
        ...
        <view class="absolute left-[10rpx] top-[10rpx] rounded-full bg-[rgba(0,0,0,0.45)] px-[12rpx] py-[6rpx] text-[18rpx] text-white">
          {{ statusLabel(item.status) }}
        </view>
        <view class="absolute right-[10rpx] top-[10rpx] rounded-full bg-[rgba(0,0,0,0.45)] px-[12rpx] py-[6rpx] text-[20rpx] text-white" @tap="remove(index)">
          删除
        </view>
        <view
