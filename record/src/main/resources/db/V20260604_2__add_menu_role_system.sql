...
-- 默认角色：管理员
INSERT INTO `role` (`id`, `name`, `label`, `remark`) VALUES
(1, 'admin', '管理员', '拥有所有权限'),
(2, 'editor', '编辑者', '可管理业务数据，不可管理系统配置');

-- 默认菜单：根据现有前端路由配置
-- 首页
INSERT INTO `menu` (`id`, `parent_id`, `name`, `path`, `component`, `redirect`, `title`, `icon`, `rank`, `menu_type`, `show_link`) VALUES
...
-- 管理员拥有所有菜单
INSERT INTO `role_menu` (`id`, `role_id`, `menu_id`) SELECT 100 + n, 1, n FROM (
