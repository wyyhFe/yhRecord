...
@TableName("biz_checkin_media")
@Schema(description = "打卡附件实体")
public class CheckinMedia extends BaseEntity {
    ...
    @Schema(description = "OSS 相对路径", example = "checkin/20260615/demo.jpg")
