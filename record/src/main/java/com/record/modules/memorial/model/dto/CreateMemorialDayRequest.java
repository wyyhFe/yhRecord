...
public class CreateMemorialDayRequest {
    ...
    @Schema(description = "纪念日标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "第一次旅行")
    @NotBlank
    ...
    @Schema(description = "纪念日日期", requiredMode = Schema.RequiredMode.REQUIRED, example = "2026-03-21")
    @NotNull
